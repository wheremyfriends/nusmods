...
var ICalCalendar = function(_data) {
    ...
    this.save = function(path, cb) {
        // Commented out to prevent unnecessary calls to nodejs packages
        // This function isn't called, and so shouldn't affect any functionality
     ...
     */
    this.clear = function() {
        // Was `require('os').hostname()` originally, patched to prevent
        // unnecessary calls on nodejs packages
        data.domain = "nusmods.com";
