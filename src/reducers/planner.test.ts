...
describe(ADD_PLANNER_MODULE, () => {
  ...
  test("can insert multiple modules in order", () => {
    ...
    const insertCS1231 = addPlannerModule("2018/2019", 1, {
      type: "module",
      moduleCode: "CS1231",
    });

    expect(
      reducer(reducer(defaultState, insertCS1010S), insertCS1231).modules,
    ).toEqual({
      0: {
        id: "0",
        moduleCode: "CS1010S",
...
describe(MOVE_PLANNER_MODULE, () => {
  ...
  test("should move modules between same semester", () => {
    expect(
      reducer(initial, movePlannerModule("2", "2018/2019", 2, 0)).modules,
    ).toEqual({
      0: {
        id: "0",
        moduleCode: "CS1010S",
  ...
  test("should move module to other acad year or semester", () => {
    ...
    expect(
      reducer(initial, movePlannerModule("2", "2018/2019", 1, 0)).modules,
    ).toEqual({
      0: {
        id: "0",
        moduleCode: "CS1010S",
    ...
    expect(
      reducer(initial, movePlannerModule("0", "2017/2018", 2, 0)).modules,
    ).toEqual({
      0: {
        id: "0",
        moduleCode: "CS1010S",
    ...
    expect(
      reducer(initial, movePlannerModule("0", "2018/2019", 2, 1)).modules,
    ).toEqual({
      0: {
        id: "0",
        moduleCode: "CS1010S",
